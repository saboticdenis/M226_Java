...
public class Body extends SmoothMover
{
    ...
    /**
     * Wendet die AnziehungskrŠfte aller anderen Himmelskšrper in diesem Universum an.
     */
    ...
    private void applyGravity(Body other)
    {
        ...
        Vector dv = new Vector (dx, dy); //setzt Richtung korrekt; Länge immer noch fehlerhaft
